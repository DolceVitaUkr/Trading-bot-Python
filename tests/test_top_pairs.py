...
def mock_exchange():
    ...
    exchange.markets = {
        ...
        "SOL/USDT": {
            "spot": True, "active": True, "base": "SOL", "quote": "USDT"},
        "XRP/USDT": {
            "spot": True, "active": False, "base": "XRP", "quote": "USDT"},
        "BTC/USDC": {
            "spot": True, "active": True, "base": "BTC", "quote": "USDC"},
    }

    tickers = {
        "BTC/USDT": {
            "quoteVolume": 500000, "percentage": 2.5,
            "ask": 50001, "bid": 50000},
        "ETH/USDT": {
            "quoteVolume": 800000, "percentage": 1.5,
            "ask": 3001, "bid": 3000},
        "SOL/USDT": {
            "quoteVolume": 100000, "percentage": 5.0,
            "ask": 151, "bid": 150},
    }
...
def top_pairs_instance(mock_exchange):
    """
    Fixture for a TopPairs instance with a mocked exchange.
    """
    return TopPairs(
...
def test_get_top_pairs(top_pairs_instance):
    """
    Tests the get_top_pairs method.
    """
...
def test_get_top_pairs_with_stats(top_pairs_instance):
    """
    Tests the get_top_pairs_with_stats method.
    """
...
def test_caching(top_pairs_instance):
    """
    Tests the caching mechanism of the TopPairs class.
    """
