...
from TradingBot.brokers.ExchangeBybit import Exchange_Bybit
...
from TradingBot.core.NullAdapters import (NullExecution, NullMarketData,
                                          NullWalletSync)
from TradingBot.core.schemas import BranchStatus
from TradingBot.learning.TrainMLModel import Train_ML_Model
from TradingBot.learning.TrainRLModel import \
    ForexSpotTrainer as Train_RL_Model
    ...
    def _build_pipeline(self):
        ...
        if self.broker == "IBKR":
            ...
            if self.product_name == "FOREX_SPOT":
                self.pipeline["trainer"] = Train_RL_Model(market_fetcher)
            ...
            bybit_adapter = Exchange_Bybit(product_name=self.product_name, mode=self.mode)
            ...
            self.pipeline["trainer"] = Train_ML_Model(market_fetcher=bybit_adapter)
