...
ibkr_rate_limiter = RateLimiter(rps_limit=40, historical_limit=58, historical_period=600)

# Bybit limits: ~50 req/sec for most endpoints, but we'll be conservative.
bybit_rate_limiter = RateLimiter(rps_limit=45, historical_limit=50, historical_period=60)
