...
# from core.interfaces import IMarketDataFetcher
...
class CryptoTrainer:
    ...
    """
    def __init__(self, market_fetcher: BybitV5Adapter):
        """
        Initializes the crypto trainer.

        :param market_fetcher: An instance of a market data fetcher, like BybitV5Adapter.
        """
