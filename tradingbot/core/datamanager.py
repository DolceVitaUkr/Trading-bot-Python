...
from tradingbot.brokers.exchangebybit import ExchangeBybit as ExchangeAPI
...
def _build_paths(symbol: str,
    ...
    paths = config_manager.get_config().get("paths", {})
    base = os.path.join(paths.get("historical_data", "data/historical"),
                        exchange_name.lower(),
                        timeframe)
